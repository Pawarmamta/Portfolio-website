...
const projects = [
  {
    ...
    description:
      "Web-based simulator for studying and comparing page replacement algorithms like FIFO, LRU, MRU, and Optimal with real-time visualization.",
    techStack: [
      "React.js",
      "JavaScript",
      "HTML",
    ...
    demo: "https://virtual-memory-manager.vercel.app/",
  ...
  },
  {
    ...
    description:
      "Artist discovery platform where users can explore artists by category, location, and price. Includes a dashboard, filters, and onboarding form.",
    techStack: ["Next.js", "JavaScript", "HTML", "CSS"],
